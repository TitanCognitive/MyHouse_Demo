...
TITAN_HANDLE64                                        MyObject::m_coordinate_interface_label = NULL;
TITAN_HANDLE64                                        MyObject::m_coordinate_label = NULL;
TITAN_HANDLE64                                        MyObject::m_transform_label = NULL;
TITAN_HANDLE64                                        MyObject::m_color_label = NULL;

/*
   Class constructor
*/
MyObject::MyObject(TITAN_HANDLE64 handshake) : TitanAxiom(handshake)
{
   ...
   // Initialize pointers
   m_pose_transforms = NULL;
   m_armature_handle = NULL;
   manifold_handle = NULL;
   m_object_handle = NULL;
   m_pose_handle = NULL;
   m_animation = NULL;
   m_animation_coordinates = NULL;
   m_GL = NULL;
   m_scene = NULL;
   m_load_model_name = NULL;
   m_camera = NULL;
   m_selected_object = NULL;
   m_last_object = NULL;
   m_max_trail_coordinates = 1024;
   m_num_trail_coordinates = 0;

   // Clear default instance
   memset(&m_instance, 0, sizeof(object_data_t));
}
...
*/
TITAN_HANDLE64 MyObject::GetElement(TITAN_HANDLE64 directive, atlas_directive_component_t component_id, atlas_reference_info_t &reference_info, 
                                    object_data_t **instance_data, TITAN_BITMAP64 query_flags)
{
   ...
   if (instance_data)
      ...
      if (reference_info.element) *instance_data = _RP(object_data_t, reference_info.element);
      else if ((*instance_data = _RP(object_data_t, reference_info.instance)) == NULL) return 0;
      }
